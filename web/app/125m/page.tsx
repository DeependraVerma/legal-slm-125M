...
import { ARCH, CHAT_PRESETS, HERO_STATS, HF_SFT_URL, HF_URL, INFRA_NOTE, MIX, NUMBERS, SFT_STATS } from "@/app/lib/model";
import { FAQS, GITHUB_URL, HF_PROFILE_URL, JOB_TITLE_LINE, PERSON_NAME } from "@/app/lib/seo";

export const metadata = {
  title: "legal-slm-125M — a 125M-parameter legal & financial LLM built from scratch",
};

export default function Page() {
  return (
    <main style={{ position: "relative", zIndex: 2 }}>
      <Nav variant="125m" hfUrl={HF_URL} otherHref="/500m" otherLabel="Try the 500M model →" />
      <Hero />
      ...
      <Section n="02" eyebrow="Chat" title="Now ask it a question">
        ...
        <Chat
          ...
          caveat="A 125M fine-tuned model. It answers one question at a time and will confidently invent case names and figures. Not legal or financial advice."
        />
      </Section>
      ...
      <Section n="06" eyebrow="The corpus" title="Two billion tokens, hand-cleaned">
        ...
        <div className="paper-card" style={{ marginTop: "1.75rem", padding: "2rem" }}>
          <DonutMix mix={MIX} centerValue="2.04B" centerLabel="TOKENS" />
        </div>
      </Section>
      ...
      <Section n="08" eyebrow="About" title="Who built this, and why">
        <div style={{ display: "grid", gap: "1.1rem", maxWidth: "52ch" }}>
          <p style={lead}>
            ...
            Q&amp;A assistant. A larger{" "}
            <a href="/500m" className="link-underline" style={{ color: "var(--green)" }}>528.5M-parameter successor ↗</a>{" "}
            followed, trained on more and better-balanced legal/financial data.
          </p>
          <p style={lead}>
    ...
    <footer style={{ borderTop: "1px solid var(--line)", background: "var(--paper-3)" }}>
      <div className="wrap" style={{ padding: "2.5rem 1.75rem", display: "flex", flexWrap: "wrap", gap: "1.5rem", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", gap: "1.5rem", fontSize: "0.85rem", flexWrap: "wrap" }}>
          <a href="/500m" className="link-underline">Try the 500M model →</a>
